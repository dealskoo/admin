...
class PasswordResetTest extends TestCase
{
    ...
    public function test_reset_password_screen_can_be_rendered()
    {
        ...
        $this->post(route('admin.password.request'), ['email' => $admin->email]);

        Notification::assertSentTo($admin, ResetAdminPassword::class, function ($notification) {
    ...
    public function test_password_can_be_reset_with_valid_token()
    {
        ...
        Notification::assertSentTo($admin, ResetAdminPassword::class, function ($notification) use ($admin) {
