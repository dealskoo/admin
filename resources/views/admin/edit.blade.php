...
@section('title',__('admin::admin.edit_admin'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('admin::admin.edit_admin') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('admin::admin.edit_admin') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required
                                           value="{{ old('name',$admin->name) }}" autofocus tabindex="1"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" required
                                           value="{{ old('email',$admin->email) }}" autofocus tabindex="2" readonly
                                           placeholder="{{ __('admin::admin.name_placeholder') }}">
                                </div>
                            </div>
                        </div> <!-- end row -->
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="bio" rows="4" name="bio" tabindex="3"
                                              placeholder="{{ __('admin::admin.bio_placeholder') }}">{{ old('bio',$admin->bio) }}</textarea>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row -->
                        <div class="row">
